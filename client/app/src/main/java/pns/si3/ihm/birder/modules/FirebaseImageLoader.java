 ...
 *
 * Allows glide to load images from firebase storage.
 */
public class FirebaseImageLoader implements ModelLoader<StorageReference, InputStream> {
    ...
    /**
     * Factory to load images form firebase storage.
     */
    ...
    public LoadData<InputStream> buildLoadData(
    	@NonNull StorageReference reference,
		int height,
		int width,
	...
	/**
	 * Key to load images from firebase storage.
	 */
	...
	/**
	 * Data fetcher to load images from firebase storage.
	 */
